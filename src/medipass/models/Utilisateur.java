...
public class Utilisateur {
    ...
    protected boolean sexe; // true = homme, false = femme
    ...
    // ---- CONSTRUCTEURS ----
    public Utilisateur(int id, String nom, String prenom, String login, LocalDate dateNaissance, boolean sexe,
    ...
    public Utilisateur(String nom, String prenom, String login, LocalDate dateNaissance, boolean sexe,
			long numTel, String email, String password, Role role, int nivAcces, long numOrdre, Specialite spe) {
    ...
    public int getNivAcces() { return nivAcces; }
	public long getNumOrdre() {	return numOrdre;}
