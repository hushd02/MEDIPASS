...
public class Medecin extends Utilisateur{
	...
	//constructeur
	public Medecin(int id, String nom, String prenom,String ident, int age, boolean sexe,
	...
	public Medecin(String nom, String prenom, String ident, int age, boolean sexe,
			long numTel, String email, String motDePasse,int nivAcces, long numOrdreM, int specialite) {
